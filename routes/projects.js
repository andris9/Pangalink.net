...
function serveAddProject(req, res) {
    res.render('index', {
        ...
        authorized: tools.processAuthorized(req.query.authorized || ''),
    ...
    db.findOne(
        ...
        (err, record) => {
            ...
            res.render('index', {
                ...
                authorized: tools.processAuthorized(req.body.authorized || record.authorized || ''),
...
function handleAddProject(req, res) {
    ...
    req.body.authorized = tools.processAuthorized(req.body.authorized || '');
    ...
    if (error) {
        ...
        res.render('index', {
            ...
            authorized: tools.processAuthorized(req.body.authorized || ''),
    ...
    db.findOne(
        ...
        (err, record) => {
            ...
            tools.generateKeys(req.user, 20 * 365, Number(req.body.keyBitsize) || 1024, (err, userCertificate, bankCertificate) => {
                ...
                record.authorized = tools.processAuthorized(req.body.authorized || '');
